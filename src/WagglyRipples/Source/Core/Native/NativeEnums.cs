...
namespace FriskyMouse.NativeApi
{
    ...
    public enum WindowStyles : uint
    {
        ...
        /// <summary>
        /// Windows 2000/XP: Creates a _layeredWindow window. Note that this cannot be used for child windows. Also, this cannot be used if the window has a class style of either <see cref="CS_OWNDC"/> or <see cref="CS_CLASSDC"/>.
        /// </summary>
